...
public class SignServiceImpl implements SignService {
    ...
    @Override
    public SignUpResultDto signUp(String email, String password, String name, String birth, int gender, String nickname, String position, String phone, String intro, String preffered_time, String preffered_area, int role) {
