...
import com.ssonsal.football.admin.entity.Game;
...
public interface GameRepository extends JpaRepository<Game, Long> {
    ...
    // 게임 리스트
    @Query("SELECT new com.ssonsal.joon.dto.request.GameDTO(t.id, t.createdAt, t.matchStatus, t.vsFormat, t.stadium, t.schedule) FROM Game t")
