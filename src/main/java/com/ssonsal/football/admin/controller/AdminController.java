...
public class AdminController {
    ...
    @GetMapping("/main")
    public ResponseEntity<ResponseBodyFormatter> getDashboard() {
        ...
        return DataResponseBodyFormatter.put(AdminSuccessCode.USER_COUNT_SUCCESS, statsService.getAdminStats());
