...
public interface SubApplicantService {
     ...
     * 용병 신청을 거절하는 기능
     *
     * @param loginUserId          신청을 거절하고자 하는 회원의 아이디
     * @param userTeamId           신청을 거절하고자 하는 회원의 소속 팀 아이디
     * @param targetSubApplicantId 거절하고자 하는 해당 용병 신청 아이디
     * @return 거절된 용병의 회원 아이디
     */
    Long rejectSubApplicant(Long loginUserId, Long userTeamId, Long targetSubApplicantId);
